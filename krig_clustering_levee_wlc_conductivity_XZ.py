# -*- coding: utf-8 -*-
"""
Created on Mon Sep 23 17:41:08 2024
...
#%%  ordinary kriging with x ,z axies
#%% conductivity 2D x and z
...
#%% 
gridx=np.arange(0.0,2,0.01,dtype='float64') 
gridz=np.arange(0.0,0.50,0.0025, dtype='float64')  #  for make make both array size same. ValueError: All arrays must be of the same length
# gridz=np.arange(0.0,0.45,0.0288888888888889, dtype='float64') 
zstar,ss=OK.execute("grid", gridx, gridz)
...
cax = ax.imshow(zstar, extent=(0, 2, 0, 0.5), origin='lower')

# Add scatter plot
ax.scatter(x, z, marker='.', s=100, facecolors='none', edgecolors='k')
...
# Set more x-ticks
ax.set_xticks(np.arange(0, 2.1, 0.25))  # Adjust step size for more tick marks
ax.set_yticks(np.arange(0, 0.5, 0.10))  # Adjust step size for more tick marks
# Save the plot
# plt.savefig('plots/spatial_krigtest_2Dxz_TS1_1448s.png', dpi=400)
# plt.savefig('plots/spatial_krigtest_2Dxz_TS1_1448s.pdf', dpi=400)
# plt.savefig('plots/spatial_krigtest_2Dxz_TS2_2349.091s.png', dpi=400)
# plt.savefig('plots/spatial_krigtest_2Dxz_TS2_2349.091s.pdf', dpi=400)
# plt.savefig('plots/spatial_krigtest_2Dxz_TS3_3188.7081s.png', dpi=400)
# plt.savefig('plots/spatial_krigtest_2Dxz_TS3_3188.7081s.pdf', dpi=400)
# plt.savefig('plots/spatial_krigtest_2Dxz_TS4_4908.402s.png', dpi=400)
# plt.savefig('plots/spatial_krigtest_2Dxz_TS4_4908.402s.pdf', dpi=400)
# plt.savefig('plots/spatial_krigtest_2Dxz_TS5_6567.4691s.png', dpi=400)
# plt.savefig('plots/spatial_krigtest_2Dxz_TS5_6567.4691s.pdf', dpi=400)
plt.show()
...
all_x = np.tile(gridx, gridx.shape[0])
all_z = np.transpose(np.tile(gridz, (gridz.shape[0], 1))).flatten()
all_v = zstar.flatten()
df = pd.DataFrame({"x_cord": all_x,
                   "z_cord": all_z,
                   "voltage": all_v})
...
# colors = np.array(['g','c', 'orange'])  # You can add more colors if k > 3 TS2_2349.091s
# colors = np.array(['orange','g','c'])  # You can add more colors if k > 3  TS3_3188.7081s
# colors = np.array(['orange','c','g'])  # You can add more colors if k > 3  TS4 4908.402s
# colors = np.array(['g','c','orange'])  # You can add more colors if k > 3  TS5_6567.4691s
...
# Plot the data
fig, ax = plt.subplots()
scatter = ax.scatter(df["x_cord"], df["z_cord"], c=df["Color"])
...
plt.savefig('plots/clustering_2Dxz_TS1_1448s.png',dpi=400)
plt.savefig('plots/clustering_2Dxz_TS1_1448s.pdf',dpi=50)
# save clustering plots
# plt.savefig('plots/clustering_2Dxz_TS2_2349.091s.png',dpi=400)
# plt.savefig('plots/clustering_2Dxz_TS2_2349.091s.pdf',dpi=50)
# plt.savefig('plots/clustering_2Dxz_TS3_3188.7081s.png',dpi=400)
# plt.savefig('plots/clustering_2Dxz_TS3_3188.7081s.pdf',dpi=50)
# plt.savefig('plots/clustering_2Dxz_TS4_4908.402s.png',dpi=400)
# plt.savefig('plots/clustering_2Dxz_TS4_4908.402s.pdf',dpi=50)
# plt.savefig('plots/clustering_2Dxz_TS5_6567.4691s.png',dpi=400)
# plt.savefig('plots/clustering_2Dxz_TS5_6567.4691s.pdf',dpi=50)
