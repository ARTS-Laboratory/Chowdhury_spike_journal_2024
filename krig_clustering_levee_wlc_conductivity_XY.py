# -*- coding: utf-8 -*-
"""
Created on Sun Sep 22 12:55:00 2024
...
#%%  ordinary kriging with x ,y axies
...
gridy=np.arange(0.0,1,0.005, dtype='float64')  #  for make make both array size same. ValueError: All arrays must be of the same length
...
cax = ax.imshow(zstar, extent=(0, 2, 0, 1), origin='lower')

# Add scatter plot
ax.scatter(x, y, marker='.', s=100, facecolors='none', edgecolors='k')
...
# Save kriging plots
# plt.savefig('plots/spatial_krigtest_2Dxy_TS1_1448s.png', dpi=400)
# plt.savefig('plots/spatial_krigtest_2Dxy_TS1_1448s.pdf', dpi=400)
# plt.savefig('plots/spatial_krigtest_2Dxy_TS2_2349.091s.png', dpi=400)
# plt.savefig('plots/spatial_krigtest_2Dxy_TS2_2349.091s.pdf', dpi=400)
# plt.savefig('plots/spatial_krigtest_2Dxy_TS3_3188.7081s.png', dpi=400)
# plt.savefig('plots/spatial_krigtest_2Dxy_TS3_3188.7081s.pdf', dpi=400)
# plt.savefig('plots/spatial_krigtest_2Dxy_TS4_4908.402s.png', dpi=400)
# plt.savefig('plots/spatial_krigtest_2Dxy_TS4_4908.402s.pdf', dpi=400)
plt.savefig('plots/spatial_krigtest_2Dxy_TS5_6567.4691s.png', dpi=400)
plt.savefig('plots/spatial_krigtest_2Dxy_TS5_6567.4691s.pdf', dpi=400)
# plt.show()
...
all_y = np.transpose(np.tile(gridy, (gridy.shape[0], 1))).flatten()
all_v = zstar.flatten()
...
# colors = np.array(['c', 'g', 'orange'])  # You can add more colors if k > 3 TS1_TS1_1448s
...
# Plot the data
fig, ax = plt.subplots()
scatter = ax.scatter(df["x_cord"], df["y_cord"], c=df["Color"])
...
# plt.savefig('plots/clustering_2Dxy_TS1_1448s.png',dpi=400)
# plt.savefig('plots/clustering_2Dxy_TS1_1448s.pdf',dpi=50)
# plt.savefig('plots/clustering_2Dxy_TS2_2349.091s.png',dpi=400)
# plt.savefig('plots/clustering_2Dxy_TS2_2349.091s.pdf',dpi=50)
# plt.savefig('plots/clustering_2Dxy_TS3_3188.7081s.png',dpi=400)
# plt.savefig('plots/clustering_2Dxy_TS3_3188.7081s.pdf',dpi=50)
# plt.savefig('plots/clustering_2Dxy_TS4_4908.402s.png',dpi=400)
# plt.savefig('plots/clustering_2Dxy_TS4_4908.402s.pdf',dpi=50)
plt.savefig('plots/clustering_2Dxy_TS5_6567.4691s.png',dpi=400)
plt.savefig('plots/clustering_2Dxy_TS5_6567.4691s.pdf',dpi=50)
